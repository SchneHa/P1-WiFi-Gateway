...
*/
      ...
      str += F("<td width='25%'><input type='radio' id='day' name='period' value='day' checked /><center><label for='day'>vandaag</label></center></td>");
      str += F("<td width='25%'><input type='radio' id='week' name='period' value='week' /><center><label for='week'>deze week</label></center></td>");
      str += F("<td width='25%'><input type='radio' id='month' name='period' value='month' /><center><label for='month'>deze maand</label></center></td>");
      str += F("<td width='25%'><input type='radio' id='year' name='period' value='year' /><center><label for='year'>dit jaar</label></center></td></tr></table></br>");
      str += F("</div>");
...
*/  
 ...
 //  str += F("<form action='/Dir' method='GET'><button type='submit'>Directory</button></form>");
      ...
      str += F("<div ><table width='95%' ><tr>");
      str += F("<td width='25%'><input type='radio' id='day' name='period' value='day' checked /><center><label for='day'>aujourd'hui</label></center></td>");
      str += F("<td width='25%'><input type='radio' id='week' name='period' value='week' /><center><label for='week'>cette semaine</label></center></td>");
      str += F("<td width='25%'><input type='radio' id='month' name='period' value='month' /><center><label for='month'>ce mois-ci</label></center></td>");
      str += F("<td width='25%'><input type='radio' id='year' name='period' value='year' /><center><label for='year'>cette année</label></center></td></tr></table></br>");
      str += F("</div>");	  
...
/*	  
      ...
      str += F("<input type='radio' id='year' name='period' value='year'><label for='year'>i år</label></br>");
      str += F("</div>");
*/
      ...
      str += F("<td width='25%'><input type='radio' id='month' name='period' value='month' /><center><label for='month'>denna månad</label></center></td>");
      str += F("<td width='25%'><input type='radio' id='year' name='period' value='year' /><center><label for='year'>i år</label></center></td></tr></table></br>");
      str += F("</div>");
